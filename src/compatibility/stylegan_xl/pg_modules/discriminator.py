...
from src.compatibility.stylegan_xl.pg_modules.blocks import conv2d, DownBlock, DownBlockPatch
...
class ProjectedDiscriminator(torch.nn.Module):
    ...
    def forward(self, x, c):
        ...
        for bb_name, feat in self.feature_networks.items():
            ...
            x_aug = lambda x: x # DiffAugment(x, policy='color,translation,cutout') if self.diffaug else x
